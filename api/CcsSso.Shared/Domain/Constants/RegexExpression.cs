namespace CcsSso.Shared.Domain.Constants
{
  public static class RegexExpression
  {
    ...
    public const string VALID_GROUP_NAME = @"^[a-zA-Z\s*0-9-,.&/()“+#;:@']{3,256}$";
    public const string VALID_CONTACT_NAME = @"^[a-zA-Z\s*0-9-.,'/&()]{3,256}$";
    //public const string VALID_STREET_ADDRESS = @"^[a-zA-Z0-9-,.&/()“+#;:@']{1,256}$";
    public const string VALID_STREET_ADDRESS = @"^[a-zA-Z\s*0-9-,.&/()“+#;:@']{1,256}$";
    public const string VALID_LOCALITY = @"^[a-zA-Z\s*0-9-.,&/']{0,256}$";
    public const string VALID_SITENAME = @"^[a-zA-Z\s*0-9-,.&/()“+#;:@']{3,256}$";
  }
}
