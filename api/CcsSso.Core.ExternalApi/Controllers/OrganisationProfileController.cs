...
namespace CcsSso.ExternalApi.Controllers
{
    ...
    public class OrganisationProfileController : ControllerBase
    {
        ...
        public async Task<UserListResponse> GetUsers(string organisationId, [FromQuery] ResultSetCriteria resultSetCriteria, [FromQuery(Name = "search-string")] string searchString, [FromQuery(Name = "include-self")] bool includeSelf = false, [FromQuery(Name = "delegated-only")] bool isDelegatedOnly = false, [FromQuery(Name = "delegated-expired-only")] bool isDelegatedExpiredOnly = false)
        {
            ...
            return await _userProfileService.GetUsersAsync(organisationId, resultSetCriteria, searchString, includeSelf, isDelegatedOnly, isDelegatedExpiredOnly);
        }
