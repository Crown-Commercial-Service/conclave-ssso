    ...
    public static IHostBuilder CreateHostBuilder(string[] args) =>
        Host.CreateDefaultBuilder(args)
            .ConfigureServices((hostContext, services) =>
            {
              ...
              var securityApiSettings = JsonConvert.DeserializeObject<SecurityApiSettings>(secrets["SecurityApiSettings"].ToString());
              var scheduleJobSettingsVault = JsonConvert.DeserializeObject<ScheduleJobSettingsVault>(secrets["ScheduleJobSettings"].ToString());
              ...
              services.AddSingleton<IDataTimeService, DataTimeService>();
