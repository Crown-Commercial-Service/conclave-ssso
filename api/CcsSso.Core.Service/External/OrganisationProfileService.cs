...
namespace CcsSso.Core.Service.External
{
  public partial class OrganisationProfileService : IOrganisationProfileService
  {
    ...
    public async Task ActivateOrganisationByUser(string userId)
    {
      ...
      {
        await ActivateOrganisation(user, ciiOrganisationId);
      }
    }

    private async Task ActivateOrganisation(User user, string ciiOrganisationId)
    {
      var organisation = await _dataContext.Organisation
    ...
    public async Task<OrganisationUserGroup> GetOrganisationGroupTypeAdminGroupDetailsAsync(string ciiOrganisationId)
    {
      ...
      var organisation = await _dataContext.Organisation
        .Include(o => o.UserGroups.Where(x => x.GroupType == (int)GroupType.Admin))
        .FirstOrDefaultAsync(o => !o.IsDeleted && o.CiiOrganisationId == ciiOrganisationId);
