...
namespace CcsSso.Adaptor.Service
{
  public class AttributeMappingService : IAttributeMappingService
  {
    ...
    /// </summary>
    /// <param name="salesForceInfo"></param>
    /// <param name="attributeMappings"></param>
    /// <returns></returns>
    public Dictionary<string, object> GetMappedSalesforceInfo(SalesForceInfo salesForceInfo, Dictionary<string, string> attributeMappings)
    {
      Dictionary<string, object> resultDictionary = new Dictionary<string, object>();

      if (attributeMappings.ContainsKey("All"))
      {
        resultDictionary.Add(attributeMappings["All"], salesForceInfo);
      }
      if (attributeMappings.ContainsKey("Urn"))
      {
        resultDictionary.Add(attributeMappings["Urn"], salesForceInfo.Urn);
      }
      if (attributeMappings.ContainsKey("Id"))
      {
        resultDictionary.Add(attributeMappings["Id"], salesForceInfo.Id);
      }
