...
namespace CcsSso.Adaptor.Service.Wrapper
{
  public class WrapperUserContactService : IWrapperUserContactService
  {
    ...
    {
      var result = await _wrapperApiService.GetAsync<WrapperUserContactInfo>(WrapperApi.User, $"contacts/{contactPointId}?userId={userName}",
    ...
    {
      var result = await _wrapperApiService.GetAsync<WrapperUserContactInfoList>(WrapperApi.User, $"contacts?userId={userName}",
    ...
    {
      var result = await _wrapperApiService.PostAsync<int>(WrapperApi.User, $"contacts/?userId={userName}", wrapperContactPointRequest,
    ...
    {
      await _wrapperApiService.PutAsync(WrapperApi.User, $"contacts/{contactPointId}?userId={userName}", wrapperContactPointRequest,
