...
namespace CcsSso.Adaptor.Service.Wrapper
{
  public class WrapperUserContactService : IWrapperUserContactService
  {
    ...
    {
      var result = await _wrapperApiService.GetAsync<WrapperUserContactInfo>(WrapperApi.User, $"contacts/{contactPointId}?userId={HttpUtility.UrlEncode(userName)}",
    ...
    {
      var result = await _wrapperApiService.GetAsync<WrapperUserContactInfoList>(WrapperApi.User, $"contacts?userId={HttpUtility.UrlEncode(userName)}",
    ...
    {
      var result = await _wrapperApiService.PostAsync<int>(WrapperApi.User, $"contacts/?userId={HttpUtility.UrlEncode(userName)}", wrapperContactPointRequest,
    ...
    {
      await _wrapperApiService.PutAsync(WrapperApi.User, $"contacts/{contactPointId}?userId={HttpUtility.UrlEncode(userName)}", wrapperContactPointRequest,
