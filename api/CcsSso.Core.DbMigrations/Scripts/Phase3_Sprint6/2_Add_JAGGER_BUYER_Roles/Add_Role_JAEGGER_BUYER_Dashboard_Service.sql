...
SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'JAEGGER_BUYER_DS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('JAEGGER_BUYER', 'eSourcing Tile for Buyer User', 'eSourcing Tile for Buyer User', 2, 0, 1,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'JAEGGER_BUYER' AND "CcsAccessRoleName" = 'eSourcing Tile for Buyer User' LIMIT 1;
