...
SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'CAS_USER_DS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('CAS_USER', 'Contract Award Service (CAS) - add to dashboard', 'Contract Award Service (CAS) - add to dashboard', 2, 0, 1,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'CAS_USER' AND "CcsAccessRoleName" = 'Contract Award Service (CAS) - add to dashboard' LIMIT 1;
