...
if (clientServiceId is null) then
 ...
 IF EXISTS (SELECT "Id" FROM public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'DMP_SUPPLIER' AND "CcsAccessRoleName" = 'Access DMP' LIMIT 1) THEN
...
INSERT INTO public."ServicePermission"(
	...
	VALUES ('DMP_SUPPLIER_DS', clientServiceId, 0, 0, now(), now(), false);

SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'DMP_SUPPLIER_DS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	 VALUES ('DMP_SUPPLIER', 'Access DMP', 'Access DMP', 2, 1, 2,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'DMP_SUPPLIER' AND "CcsAccessRoleName" = 'Access DMP' LIMIT 1;
