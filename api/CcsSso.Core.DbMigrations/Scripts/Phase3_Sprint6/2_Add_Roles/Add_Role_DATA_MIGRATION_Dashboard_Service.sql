...
SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'DATA_MIGRATION_DS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('DATA_MIGRATION', 'Access Data Migration', 'Access Data Migration', 0, 0, 2,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'DATA_MIGRATION' AND "CcsAccessRoleName" = 'Access Data Migration' LIMIT 1;
