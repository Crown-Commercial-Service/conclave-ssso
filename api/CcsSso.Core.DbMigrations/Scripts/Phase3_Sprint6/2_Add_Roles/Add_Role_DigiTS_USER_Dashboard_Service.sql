...
SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'DigiTS_USER_DS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('DigiTS_USER', 'Access DigiTS', 'Access DigiTS', 2, 1, 1,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'DigiTS_USER' AND "CcsAccessRoleName" = 'Access DigiTS' LIMIT 1;
