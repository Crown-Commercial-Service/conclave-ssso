...
SELECT AddGroupRoleMapping('CAS_GROUP','CAS_USER','Contract Award Service (CAS) - add service');
SELECT AddGroupRoleMapping('CAS_GROUP','CAS_USER','Contract Award Service (CAS) - add to dashboard');
SELECT AddGroupRoleMapping('CAS_GROUP','CAS_USER','Contract Award Service role to create buyer in Jagger-LD');
