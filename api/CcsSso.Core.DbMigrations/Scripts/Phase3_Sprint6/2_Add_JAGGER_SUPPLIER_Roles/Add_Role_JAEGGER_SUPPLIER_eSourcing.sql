...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('JAEGGER_SUPPLIER', 'eSourcing  Supplier role to access Jagger', 'eSourcing  Supplier role to access Jagger', 2, 0, 0,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'JAEGGER_SUPPLIER' AND "CcsAccessRoleName" = 'eSourcing  Supplier role to access Jagger' LIMIT 1;
