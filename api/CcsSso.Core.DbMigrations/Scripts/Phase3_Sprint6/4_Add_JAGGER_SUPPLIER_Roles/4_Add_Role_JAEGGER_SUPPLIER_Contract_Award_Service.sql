...
SELECT "Id" into ServicePermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'JAEGGER_SUPPLIER_CAS' AND "CcsServiceId" = clientServiceId  LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('JAEGGER_SUPPLIER', 'eSourcing  Supplier role for CAS for QA Pages Access', 'eSourcing  Supplier role for CAS for QA Pages Access', 2, 0, 0,0, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into RoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'JAEGGER_SUPPLIER' AND "CcsAccessRoleName" = 'eSourcing  Supplier role for CAS for QA Pages Access' LIMIT 1;
