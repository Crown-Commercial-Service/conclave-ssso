...
CREATE OR REPLACE FUNCTION create_first_user() RETURNS integer AS $$
    ...
    INSERT INTO public."User"(
	    "UserName", "JobTitle", "UserTitle", "PartyId", "OrganisationEligibleIdentityProviderId", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
	    VALUES (userName, 'TestJobTitle', 0, partyId, orgIdpId, 0, 0, now(), now(), false);
		INSERT INTO public."Person"(
			"OrganisationId", "PartyId", "Title", "FirstName", "LastName", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
