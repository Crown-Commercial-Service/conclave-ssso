...
CREATE OR REPLACE FUNCTION create_first_org() RETURNS integer AS $$
    ...
    BEGIN
		...
		INSERT INTO public."Party"(
			"PartyTypeId", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
	    ...
	    "CiiOrganisationId", "LegalName", "OrganisationUri", "RightToBuy", "PartyId", "IsActivated", "IsSme", "IsVcse", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
	    VALUES ('TestCiiOrgId1', 'TestCiiOrg', 'TestCiiOrg.com', true, partyId, true, true, true, 0, 0, now(), now(), false);
    ...
    INSERT INTO public."OrganisationEligibleRole"(
	    "OrganisationId", "CcsAccessRoleId", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
    ...
    INSERT INTO public."OrganisationEligibleIdentityProvider"(
	    "OrganisationId", "IdentityProviderId", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", "LastUpdatedOnUtc", "IsDeleted")
