...
BEGIN
	--Organisation User
	SELECT "Id" into defaultUserId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ORG_DEFAULT_USER' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (defaultUserId, true, true, true, true, true, true, true);

	--Organisation Administrator
	SELECT "Id" into orgAdminId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ORG_ADMINISTRATOR' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (orgAdminId, true, true, true, true, true, true, true);

	--esorucing service as a supplier
	SELECT "Id" into eSourcingSupplierId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'JAEGGER_SUPPLIER' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (eSourcingSupplierId,true, false, false, true, true, true, false);

	--esorucing service as buyer
	SELECT "Id" into eSourcingBuyerId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'JAEGGER_BUYER' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (eSourcingBuyerId, false, true, false, true, false, true, false);

	--esorucing service - add to dasboard
	SELECT "Id" into eSourcingDashboardId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ACCESS_JAGGAER' LIMIT 1;
	...
	SELECT "Id" into casDashboardId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ACCESS_CAAAC_CLIENT' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (casDashboardId, false, true, false, true, false, true, true);
	
	--Contract Award Service (CAS) - add service
	SELECT "Id" into casServiceId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'CAT_USER' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (casServiceId, false, true, false, true, false, true, true);

	--Access Fleet Portal - Dashboard Service
	SELECT "Id" into fleetDashboardId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ACCESS_FP_CLIENT' LIMIT 1;
	
	INSERT INTO public."AutoValidationRole"("CcsAccessRoleId", "IsSupplier", "IsBuyerSuccess", "IsBuyerFalied", "IsBothSuccess", "IsBothFailed", "AssignToOrg", "AssignToAdmin")
	VALUES (fleetDashboardId, false, true, false, true, false, true, true);

	--Fleet Portal User - Fleet Portal
	SELECT "Id" into fleetUserId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'FP_USER' LIMIT 1;
