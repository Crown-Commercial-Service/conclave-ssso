CREATE OR REPLACE FUNCTION Update_MSEAutoValidationRoleAssignment() RETURNS integer AS $$
...
$$ LANGUAGE plpgsql;
SELECT Update_MSEAutoValidationRoleAssignment();
DROP FUNCTION Update_MSEAutoValidationRoleAssignment;
