...
DECLARE serviceName text = 'Cat';
DECLARE serviceDescription text = 'Cat';
DECLARE serviceCode text = 'CAT_CLIENT';
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('ACCESS_CAT_CLIENT', 'Access CAT', 'Access CAT', 2, 1, 1, 0, 0, now(), now(), 
			false, false);			
