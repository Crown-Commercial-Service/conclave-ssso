...
INSERT INTO public."CcsService"(
	...
	VALUES ('DigiTS', 0, 0, 0, now(), now(), false, clientId, 
			clientUrl, 'Book rail, accommodation, air travel and more','DIGITS_CLIENT');
			
			
SELECT "Id" into clientServiceId From public."CcsService" WHERE "ServiceName" = 'DigiTS' LIMIT 1;
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('DIGITS_DEPARTMENT_ADMIN', 'Department Admin', 'Department Admin', 2, 1, 2, 0, 0, now(), now(), 
			false, true);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('DIGITS_CONTRACT_OWNER', 'Contract Owner', 'Contract Owner', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('DIGITS_MI', 'MI', 'MI', 2, 1, 2, 0, 0, now(), now(), 
			false, true);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('USER', 'User', 'User', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('SERVICE_ADMIN', 'Service Admin', 'Service Admin', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('PROVIDER_APP', 'API Access Role', 'API Access Role', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('ACCESS_DIGITS_CLIENT', 'Access DigiTS', 'Access DigiTS', 2, 1, 2, 0, 0, now(), now(), 
			false, false);			
