...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('EL_SNR_BUYER', 'Snr Buyer', 'Snr Buyer', 2, 0, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('EL_JNR_BUYER', 'Jnr Buyer', 'Jnr Buyer', 2, 0, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('EL_CCS_SNR_ADMIN', 'CCS Snr Admin', 'CCS Snr Admin', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('EL_CCS_JNR_ADMIN', 'CCS Jnr Admin', 'CCS Jnr Admin', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
