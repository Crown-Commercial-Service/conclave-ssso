...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('EL_ADMIN', 'Evidence Locker Admin', 'Evidence Locker Admin', 2, 1, 2, 0, 0, now(), now(), 
			false, true);
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('EL_User', 'Evidence Locker User', 'Evidence Locker User', 2, 0, 2, 0, 0, now(), now(), 
			false, false);
