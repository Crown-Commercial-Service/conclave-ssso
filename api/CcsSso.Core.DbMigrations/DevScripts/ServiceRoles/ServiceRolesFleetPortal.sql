CREATE OR REPLACE FUNCTION create_flp_service() RETURNS integer AS $$
...
INSERT INTO public."ServicePermission"(
	...
	VALUES ('FP_USER', clientServiceId, 0, 0, now(), now(), false);	
SELECT "Id" into clientUserPermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'FP_USER' AND "CcsServiceId" = clientServiceId LIMIT 1;


INSERT INTO public."ServicePermission"(
	"ServicePermissionName", "CcsServiceId", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc","LastUpdatedOnUtc", "IsDeleted")
	VALUES ('ACCESS_FP_CLIENT', dashboardServiceId, 0, 0, now(), now(), false);	
SELECT "Id" into dbAccesClientPermissionId From public."ServicePermission" WHERE "ServicePermissionName" = 'ACCESS_FP_CLIENT' LIMIT 1;	
...
INSERT INTO public."CcsAccessRole"(
	...
	VALUES ('FP_USER', 'Fleet Portal User', 'Fleet Portal User', 2, 1, 2, 0, 0, now(), now(), 
			false, false);
SELECT "Id" into clientUserRoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'FP_USER' AND "CcsAccessRoleName" = 'Fleet Portal User' LIMIT 1;		
...
INSERT INTO public."CcsAccessRole"(
	...
	"SubscriptionTypeEligibility", "TradeEligibility", "CreatedUserId", "LastUpdatedUserId", "CreatedOnUtc", 
	"LastUpdatedOnUtc", "IsDeleted", "MfaEnabled")
	VALUES ('ACCESS_FP_CLIENT', 'Access Fleet Portal', 'Access Fleet Portal', 2, 1, 2, 0, 0, now(), now(), 
			false, false);			
SELECT "Id" into dbAccessClientRoleId From public."CcsAccessRole" WHERE "CcsAccessRoleNameKey" = 'ACCESS_FP_CLIENT' LIMIT 1;
...
SELECT create_flp_service();
DROP FUNCTION create_flp_service;
