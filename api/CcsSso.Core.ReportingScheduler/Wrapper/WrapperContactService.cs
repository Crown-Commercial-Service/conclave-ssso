...
namespace CcsSso.Core.ReportingScheduler.Wrapper
{
  public class WrapperContactService : IWrapperContactService
  {
    ...
    {
      return await _wrapperApiService.GetAsync<AuditLogResponse>(WrapperApi.Contact, $"data/audit?start-date={startDate}&pageSize={pageSize}&currentPage={currentPage}", "ERROR_GETTING_CONTACT_AUDIT_LOG");
    }
  }
}
