...
namespace CcsSso.Core.DormancyJobScheduler.Helper
{
  public class Auth0TokenHelper
  {
    private readonly DormancyAppSettings _appConfigInfo;
    private readonly IHttpClientFactory _httpClientFactory;
    private static string token;
    public Auth0TokenHelper(DormancyAppSettings appConfigInfo, IHttpClientFactory httpClientFactory)
    {
